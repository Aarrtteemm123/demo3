...
<form class="inputForm" action="/boardGames/list" method="POST">
    <div class="field">
        ...
        <input type="number" name="num" class="input" value="0">
    </div>
    <br>
    <input style="left: 193px;top: 10px;" class="button" type="submit" value="Ok">
</form>
...
<div class="table_dark">
    <table>
        ...
        <#list boardGames as tempBoardGames>
            <tr>
                <td>${tempBoardGames.id}</td>
