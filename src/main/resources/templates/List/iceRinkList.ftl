...
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 520px;top: 330px;" href="/iceRink/list">All ice rinks</a>
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 520px;top: 360px;" href="/iceRink/add">Add ice rink</a>
    ...
    <table>
        ...
        <#list iceRink as tempIceRink>
            <tr>
                ...
                <td><a href="/iceRink/delete/${tempIceRink.id}" style="color: #47e7db;text-decoration: none">Delete</a></td>
                <td>
