...
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 460px;top: 330px;" href="/court/list">All court</a>
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 460px;top: 360px;" href="/court/add">Add court</a>
<form class="inputForm" action="/court/list" method="POST">
    <div class="field">
    <label for="num">Playground (<)</label>
...
<div class="table_dark">
    <table>
        <tr>
            ...
            <th>Name</th>
            <th>Address</th>
            <th>Number of playground</th>
            <th>Delete</th>
            <th>Edit</th>
        </tr>
        <#list courts as tempCourt>
            <tr>
                <td>${tempCourt.id}</td>
                <td>${tempCourt.name}</td>
                <td>${tempCourt.address}</td>
                <td>${tempCourt.numberOfPlayground}</td>
                <td><a href="/court/delete/${tempCourt.id}" style="color: #47e7db;text-decoration: none">Delete</a></td>
                <td>
                    <a href="/court/edit/${tempCourt.id}" style="color: #47e7db;text-decoration: none">Edit</a>
                </td>
            </tr>
        </#list>
    </table>
