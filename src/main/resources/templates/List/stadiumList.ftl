...
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 410px;top: 360px;" href="/stadium/list">All stadium</a>
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 410px;top: 390px;" href="/stadium/add">Add stadium</a>
<form class="form" action="/stadium/list" method="POST">
    <div class="field">
        <label for="num">Number of viewers (<)</label>
    ...
    <br>
    <input style="left: 303px;top: 10px;" class="button" type="submit" value="Ok">
</form>
...
<div class="table_dark">
    <table>
        ...
        <#list stadiums as tempStadium>
            <tr>
                <td>${tempStadium.id}</td>
                <td>${tempStadium.name}</td>
                <td>${tempStadium.address}</td>
                <td>${tempStadium.numberOfViewers}</td>
                <td>${tempStadium.type}</td>
                <td><a href="/stadium/delete/${tempStadium.id}" style="color: #47e7db;text-decoration: none">Delete</a></td>
                <td>
                    <a href="/stadium/edit/${tempStadium.id}" style="color: #47e7db;text-decoration: none">Edit</a>
                </td>
            </tr>
        </#list>
    </table>
