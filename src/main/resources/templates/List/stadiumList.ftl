...
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 410px;top: 360px;" href="/stadium/list">All
    stadium</a>
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 410px;top: 390px;" href="/stadium/add">Add
    stadium</a>
    ...
    <table>
        ...
        <#list stadiums as tempStadium>
            <tr>
                ...
                <td><a href="/stadium/delete/${tempStadium.id}" style="color: #47e7db;text-decoration: none">Delete</a>
                </td>
                <td>
