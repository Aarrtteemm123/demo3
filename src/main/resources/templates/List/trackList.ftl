...
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 420px;top: 350px;" href="/track/list">All track</a>
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 420px;top: 380px;" href="/track/add">Add track</a>
<form class="form" action="/track/list" method="POST">
    <div class="field">
        <label for="num">Length track (<)</label>
        <input class="input" type="number" name="num" value="0">
    </div>
    <br>
    <div class="field">
        <label for="string">Type of cover</label>
        <input class="input" type="text" name="string" value="">
    </div>
    <br>
    <input style="left: 250px;top: 5px;" class="button" type="submit" value="Ok">
</form>
...
<div class="table_dark">
    <table>
        ...
        <#list tracks as tempTrack>
            <tr>
                <td>${tempTrack.id}</td>
                <td>${tempTrack.name}</td>
                <td>${tempTrack.address}</td>
                <td>${tempTrack.typeOfCover}</td>
                <td>${tempTrack.lengthTrack}</td>
                <td><a href="/track/delete/${tempTrack.id}" style="color: #47e7db;text-decoration: none">Delete</a></td>
                <td>
                    <a href="/track/edit/${tempTrack.id}" style="color: #47e7db;text-decoration: none">Edit</a>
                </td>
            </tr>
        </#list>
    </table>
