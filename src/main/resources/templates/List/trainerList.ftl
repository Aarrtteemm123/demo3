...
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 400px;top: 320px;" href="/trainer/list">All
    trainer</a>
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 400px;top: 350px;" href="/trainer/add">Add
    trainer</a>
    ...
    <table>
        ...
        <#list trainerForm as tempTrainer>
            <tr>
                ...
                <td><a href="/trainer/delete/${tempTrainer.id}" style="color: #47e7db;text-decoration: none">Delete</a>
                </td>
                <td>
