...
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 490px;top: 350px;" href="/manege/list">All manege</a>
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 490px;top: 380px;" href="/manege/add">Add manege</a>
<form class="inputForm" action="/manege/list" method="POST">
    <div class="field">
...
<div class="table_dark">
    <table>
        ...
        <#list maneges as tempManege>
            <tr>
                <td>${tempManege.id}</td>
                <td>${tempManege.name}</td>
                <td>${tempManege.address}</td>
                <td>${tempManege.typeOfCover}</td>
                <td><a href="/manege/delete/${tempManege.id}" style="color: #47e7db;text-decoration: none">Delete</a></td>
                <td>
                    <a href="/manege/edit/${tempManege.id}" style="color: #47e7db;text-decoration: none">Edit</a>
                </td>
            </tr>
        </#list>
    </table>
