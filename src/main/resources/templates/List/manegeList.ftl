...
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 490px;top: 350px;" href="/manege/list">All
    manege</a>
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 490px;top: 380px;" href="/manege/add">Add
    manege</a>
    ...
    <table>
        ...
        <#list maneges as tempManege>
            <tr>
                ...
                <td><a href="/manege/delete/${tempManege.id}" style="color: #47e7db;text-decoration: none">Delete</a>
                </td>
                <td>
