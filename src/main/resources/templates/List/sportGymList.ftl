...
<div class="table_dark">
    <table>
        <tr>
            ...
            <th>Name</th>
            <th>Address</th>
            <th>Number of simulators</th>
            <th>Delete</th>
            <th>Edit</th>
        </tr>
        <#list sportGyms as tempSportGym>
            <tr>
                <td>${tempSportGym.id}</td>
                <td>${tempSportGym.name}</td>
                <td>${tempSportGym.address}</td>
                <td>${tempSportGym.numberOfSimulators}</td>
                <td><a href="/sportGym/delete/${tempSportGym.id}"
                       style="color: #47e7db;text-decoration: none">Delete</a></td>
                <td>
                    <a href="/sportGym/edit/${tempSportGym.id}" style="color: #47e7db;text-decoration: none">Edit</a>
                </td>
            </tr>
        </#list>
    </table>
