...
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 430px;top: 350px;"
   href="/swimmingPool/list">All swimming pools</a>
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 430px;top: 380px;"
   href="/swimmingPool/add">Add swimming pool</a>
    ...
    <table>
        ...
        <#list swimmingPools as tempSwimmingPool>
            <tr>
                ...
                <td><a href="/swimmingPool/delete/${tempSwimmingPool.id}" style="color: #47e7db;text-decoration: none">Delete</a>
                </td>
                <td>
