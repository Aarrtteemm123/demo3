...
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 430px;top: 350px;" href="/swimmingPool/list">All swimming pools</a>
<a style="color: black; font-family:sans-serif,impact;position: absolute;left: 430px;top: 380px;" href="/swimmingPool/add">Add swimming pool</a>
<form class="form" action="/swimmingPool/list" method="POST">
    <div class="field">
    ...
    <br>
    <div class="field">
        <label for="num2">Towers (<)</label>
        <input class="input" type="number" name="num2" value="0">
    </div>
    <br>
    <input style="left: 210px;top: 5px;" class="button" type="submit" value="Ok">
</form>
...
<div class="table_dark">
    <table>
        <tr>
            ...
            <th>Address</th>
            <th>Depth</th>
            <th>Number of tower</th>
            <th>Delete</th>
            <th>Edit</th>
        </tr>
        <#list swimmingPools as tempSwimmingPool>
            <tr>
                <td>${tempSwimmingPool.id}</td>
                <td>${tempSwimmingPool.name}</td>
                <td>${tempSwimmingPool.address}</td>
                <td>${tempSwimmingPool.depth}</td>
                <td>${tempSwimmingPool.numberOfTower}</td>
                <td><a href="/swimmingPool/delete/${tempSwimmingPool.id}" style="color: #47e7db;text-decoration: none">Delete</a></td>
                <td>
                    <a href="/swimmingPool/edit/${tempSwimmingPool.id}" style="color: #47e7db;text-decoration: none">Edit</a>
                </td>
            </tr>
        </#list>
    </table>
