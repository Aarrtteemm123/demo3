...
<body>
<h1 style="position: absolute;left: 665px;top: 30px;">Add sport gym</h1>
<form class="form" action="/sportGym/add" method="POST">
    <div class="field">
    ...
    <div class="field">
        ...
        <input class="input"  type="text" pattern="^[0-9]+$" name="numberOfSimulators" value="0">
    </div>
    <br>
