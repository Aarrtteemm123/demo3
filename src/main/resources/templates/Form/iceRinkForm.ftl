...
<body>
<h1 style="position: absolute;left: 686px;top: 30px;">Add ice rink</h1>
<form class="form" action="/iceRink/add" method="POST">
    <div class="field">
    ...
    <div class="field">
        ...
        <input class="input" type="text" pattern="^[0-9]+$" name="square" value="0">
    </div>
    <br>
