...
<body>
<h1 style="position: absolute;left: 700px;top: 30px;">Add court</h1>
<form class="form" action="/court/add" method="POST">
    <div class="field">
    ...
    <div class="field">
        ...
        <input class="input"  type="text" pattern="^[0-9]+$" name="numberOfPlayground" value="0">
    </div>
    <br>
