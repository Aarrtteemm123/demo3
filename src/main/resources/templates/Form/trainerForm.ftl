...
<body>
<h1 style="position: absolute;left: 690px;top: 30px;">Add trainer</h1>
<form class="form" action="/trainer/add" method="POST">
    <div class="field">
    ...
    <div class="field">
        ...
        <input class="input"  type="text" pattern="^[0-9]+$" name="sportId" value="0">
    </div>
    <br>
