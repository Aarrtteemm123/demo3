...
<body>
<h1 style="position: absolute;left: 685px;top: 30px;">Edit club</h1>
<form class="form" action="/club/edit" method="POST">
    <div class="field">
        <label for="name">Name</label>
        <input class="input" type="text" name="name" value="${clubFormList.name}">
        <br>
