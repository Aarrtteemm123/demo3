...
<a style="color: black; font-family:sans-serif,impact;position: absolute;right: 20px;top: 20px;" href="/task">Task</a>
<a style="color: black; font-family:sans-serif,impact;position: absolute;right: 20px;top: 50px;" href="/document">Document</a>
<form class="form" action="/title" method="POST">
    ...
    <br>
    <input style="position: absolute;left: 260px; top: 150px; height: 35px;width: 150px;" class="button" type="submit"
           value="OK">
</form>
</body>
</html>